...
**Gaps (1):**
- T1: no responsive hero source (no srcset w/ mobile width, no CSS bg media variants)


Run `/home/deploy/bin/perf-traits-audit.sh the-kohler-group` for full detail. Remediation guidance in [performance-gate.md](/home/deploy/claude-config/rules/performance-gate.md).
<!-- perf-traits:end -->
